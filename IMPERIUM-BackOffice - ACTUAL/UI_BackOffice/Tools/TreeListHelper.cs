...
namespace UI_BackOffice.Tools
{
    public class TreeListHelper
    {
        ...
        #endregion
        public void TreeViewParaUnNodo<T>(List<T> entidadList,
           string ColumnaCod_Padre, string ColumnaDsc_Padre)
        {
            var view = new UnNodo(ColumnaCod_Padre, ColumnaDsc_Padre
                , this);
        ...
        private class UnNodo
        {
            TreeListHelper _helper;
            public UnNodo(string ColumnaCod_Padre,
                string ColumnaDsc_Padre,
                TreeListHelper helper
                )
            {
        ...
        public string ObtenerCodigoConcatenadoDeNodoIndex(int indice, string columna)
        {
            var trabChecked = _treeList.GetAllCheckedNodes();
