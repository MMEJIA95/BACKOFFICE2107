...
namespace BE_BackOffice
{
    public class eFacturaProveedor
    {
        ...
        public string cod_concepto_detraccion_SUNAT { get; set; }
        ...
        public string flg_nuevoCECO { get; set; }
        public string accion { get; set; }
        public int id_detalle { get; set; }
        public decimal numero_documentoantiguo { get; set; }
        public string tipo_documentoantiguo { get; set; }
        public string serie_documentoantiguo { get; set; }

        public string proveedorantiguo { get; set; }
        
        public int id_datoactual { get; set; }
        public string dsc_mod { get; set; }

        public string descripcion { get; set; }

        public DateTime fch_modificacion { get; set; }
        public string cod_valorantiguo { get; set; }
        public string cod_valoractual { get; set; }
        ...
        public decimal detraccion_redondo { get; set; }
        //public string new_fch_pago_ejecutado
        //{
        //    get
        //    {
        //        if (fch_pago_ejecutado.ToString().Contains("1/01/0001"))
        //        {
        //            return "";
        //        }
        //        else
        ...
        public class eFacturaProveedor_Distribucion : eFacturaProveedor
        {
            ...
            public decimal imp_distribucion { get; set; }
        ...
        public class eFaturaProveedor_ProgramacionPagos : eFacturaProveedor
        {
            ...
            //    get
            //    {
            //        if (fch_ejecucion.ToString().Contains("1/01/0001"))
            //        {
            //            return "";
            //        }
            //        else
